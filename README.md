...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/plain-union-d766
```

A live public deployment of this template is available at [https://plain-union-d766.templates.workers.dev](https://plain-union-d766.templates.workers.dev)
